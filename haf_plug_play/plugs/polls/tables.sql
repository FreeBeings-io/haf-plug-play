CREATE TABLE IF NOT EXISTS public.hpp_polls_ops(
    ppop_id BIGINT NOT NULL UNIQUE REFERENCES public.plug_play_ops(id) DEFERRED ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.hpp_polls_content(
    pp_poll_opid BIGINT NOT NULL UNIQUE REFERENCES public.hpp_polls_ops(pp_poll_opid) DEFERRED ON DELETE CASCADE,
